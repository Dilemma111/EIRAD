...
target = "Step 1. Locate the newspaper"
...
test_prefixes = [
                "Step 1. Locate the newspaper",
                "Step 1. locate newspaper",
                "Step 1. Locate newspaper",
                "Step 1. locate the newspaper",
...
def main(
    ...
    input: str = "newspaper,fridge,tissue paper,mirror,paper,SideTable, KeyChain, LightSwitch, garbage bag, GarbageCan,Cabinet, PaperTowelRoll, Cup, ButterKnife,microwave,oil,fruits,flour,bowl,knife,apple,egg,pan,plate,noodles,oil",
