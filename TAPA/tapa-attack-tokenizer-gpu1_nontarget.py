...
from llm_attacks.minimal_gcg.opt_utils_gpu1_nontarget import token_gradients, sample_control, get_logits, target_loss
from llm_attacks.minimal_gcg.opt_utils_gpu1_nontarget import load_model_and_tokenizer, get_filtered_cands
from llm_attacks.minimal_gcg.string_utils_gpu1_nontarget import SuffixManager, load_conversation_template
...
target = "Step 1. Move the cup under the coffee machine"
...
test_prefixes = [
                "Step 1. Move the cup under the coffee machine",
                "coffee mug",
                "coffee machine",
                "Grasp a cup",
                "Grasp a mug",
