...
from llm_attacks.minimal_gcg.opt_utils_VELMA3 import token_gradients, sample_control, get_logits, target_loss
from llm_attacks.minimal_gcg.opt_utils_VELMA3 import load_model_and_tokenizer, get_filtered_cands
...
modelsimilarity, vis_processors, text_processors = load_model_and_preprocess("blip2_image_text_matching", "pretrain", device="cuda:3", is_eval=True)
...
def main(
    ...
    with open("/home/liu_shuyuan/TaPA/generate/harmful-3key.json") as inputData:
        ...
        for line in json_data:
            ...
            def check_for_attack_success(model, tokenizer, input_ids, assistant_role_slice, test_prefixes,adv_suffix=None, gen_config=None):
                ...
                input_ids0 = torch.Tensor(input_ids0).long().to("cuda:3")
                        ...
                        for gen3 in gen2:
                            ...
                            for gen4 in gen3:
                                ...
                                for gen5 in gen4:
                                    ...
                                    itc_score = modelsimilarity({"image": txt2, "text_input": txt}, match_head='itc',device="cuda:3")
            ...
            for i in range(num_steps):
                ...
                with torch.no_grad():
                    ...
                    # print(is_success)
                    if is_success >= 0.85:
                        # f=open('VELMA-3key-harmful-success.txt','a')
                        # f.write(gen_str)
                        # f.write('\n')
                        # f.write(str(i))
                        # f.write('\n')
                        ...
                        f=open('VELMA-harm-3key-loss.txt','a')
                        # f.write("lose")
                        # f.write('\n')
                        f.write(gen_str)
                        f.write('\n')
