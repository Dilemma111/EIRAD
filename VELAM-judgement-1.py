...
from llm_attacks.minimal_gcg.opt_utils_VELMA1 import token_gradients, sample_control, get_logits, target_loss
from llm_attacks.minimal_gcg.opt_utils_VELMA1 import load_model_and_tokenizer, get_filtered_cands
...
modelsimilarity, vis_processors, text_processors = load_model_and_preprocess("blip2_image_text_matching", "pretrain", device="cuda:1", is_eval=True)
...
def main(
    ...
    with open("/home/liu_shuyuan/otter/pipeline/demo/judgement-10.json") as inputData:
        ...
        for line in json_data:
            ...
            def check_for_attack_success(model, tokenizer, input_ids, assistant_role_slice, test_prefixes,adv_suffix=None, gen_config=None):
                ...
                input_ids0 = torch.Tensor(input_ids0).long().to("cuda:1")
                ...
                #                     itc_score = modelsimilarity({"image": txt2, "text_input": txt}, match_head='itc',device="cuda:1")
                #                     # print('The image feature and text feature has a cosine similarity of %.4f'%itc_score)
                #                     if max_itc_score< itc_score:
                #                         max_itc_score=itc_score
                jailbroken = any([prefix in gen_str0 for prefix in test_prefixes])
                return gen_str0,jailbroken
