...
plt.plot(steps[::25], loss[::5], marker='o', linestyle='-', color='b', label='No keyword initialization')
plt.plot(steps[::25], loss2[::5], marker='*', linestyle='-', color='r', label='Keyword initialization')
...
plt.savefig('TAPA-loss_vs_steps_harmless.png')
plt.show()
