...
from llm_attacks.minimal_gcg.opt_utils_VELMA2 import token_gradients, sample_control, get_logits, target_loss
from llm_attacks.minimal_gcg.opt_utils_VELMA2 import load_model_and_tokenizer, get_filtered_cands
    ...
    with open("/home/liu_shuyuan/otter/pipeline/demo/judgement-10.json") as inputData:
        ...
        for line in json_data:
            ...
            def check_for_attack_success(model, tokenizer, input_ids, assistant_role_slice, test_prefixes,adv_suffix=None, gen_config=None):
                ...
                input_ids0 = torch.Tensor(input_ids0).long().to("cuda:2")
                ...
                txt = text_processors["eval"](target)
                txt2 = text_processors["eval"](gen_str0)
                max_itc_score = modelsimilarity({"image": txt2, "text_input": txt}, match_head='itc',device="cuda:2")
                print('max_itc_score')
                print(max_itc_score)
