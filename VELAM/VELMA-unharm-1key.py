...
def main(
    ...
    with open("/home/liu_shuyuan/otter/pipeline/demo/unharmful0-100-1key.json") as inputData:
        ...
        for line in json_data:
            ...
            for i in range(num_steps):
                ...
                with torch.no_grad():
                    ...
                    # print(is_success)
                    if is_success >= 0.85:
                        # f=open('VELMA-1key-unharm-success.txt','a')
                        # f.write(gen_str)
                        # f.write('\n')
                        # f.write(str(i))
                        # f.write('\n')
                        ...
                        f=open('VELMA-unharm-1key-loss.txt','a')
                        # f.write("lose")
                        # f.write('\n')
                        f.write(gen_str)
                        f.write('\n')
